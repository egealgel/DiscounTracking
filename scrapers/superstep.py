...
class SuperstepScraper(BaseScraper):
    def get_product_info(self, url: str) -> dict | None:
            ...
            try:
                ...
                if data.get("@type") in ("Product", "product"):
                    ...
                    if isinstance(image, list):
                        image = image[0]
                    return {
                        "name": data.get("name", "Superstep Ürünü"),
        ...
        price_el = (
            soup.find(class_=re.compile("sale-price|current-price|product-price", re.I))
            or soup.find(class_=re.compile("price", re.I))
        )
        ...
        if price_el:
            ...
            try:
                ...
                pass
        img = soup.find("img", class_=re.compile("product|main|hero", re.I))

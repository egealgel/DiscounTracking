...
class HouseOfSuperstepScraper(BaseScraper):
    def get_product_info(self, url: str) -> dict | None:
            ...
            try:
                ...
                if data.get("@type") in ("Product", "product"):
                    ...
                    if isinstance(image, list):
                        image = image[0]
                    return {
                        "name": data.get("name", "House of Superstep Ürünü"),
        ...
        for script in soup.find_all("script", id="__NEXT_DATA__"):
            try:
                ...
                if product:
                    ...
                    return {
                        "name": product.get("name", product.get("title", "House of Superstep Ürünü")),
                        "price": float(price) if price else None,
                        "currency": "TRY",
        ...
        price_el = (
            soup.find(class_=re.compile("sale-price|current-price|discounted", re.I))
        ...
        if price_el:
            ...
            try:
                ...
                pass
        img = soup.find("img", class_=re.compile("product|main|hero|featured", re.I))
